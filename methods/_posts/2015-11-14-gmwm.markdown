...
<p align="justify">
where v is the WV estimated from the sample, ν(θ) is the WV implied by the model Fθ and Ω is an appropriately chosen positive definite weighting matrix. Under certain regularity conditions, this estimator is consistent and asymptotically normal for many time series models (see Guerrier et al., 2013 for details).</p>
<p align="justify">
...
* “Robust Inference for Time Series: a Wavelet-Based Framework ”[Full Presentation](/assets/pdfs/usc_2015_rgmwm.pdf)
* “Wavelet-Variance-Based Estimation of Latent Time Series Models”[Full Presentation](/assets/pdfs/TAMU.pdf)
