...
<table>
  ...
  <span class="username">stephane (AT) illinois (dot) EDU</span></span>
  </td>
  ...
  <tr>
    <td><img src="{{ "assets/images/staff/jjbalamuta.jpg" | prepend: site.baseurl }}" alt="James Balamuta" class="staff-picture" />
      <br />
  <span><i class="fa fa-envelope-o"></i>
  <span class="username">balamut2 (AT) illinois (dot) EDU</span></span>
  </td>
  ...
  <tr>
    <td><img src="{{ "assets/images/staff/rmolinari.jpg" | prepend: site.baseurl }}" alt="Roberto Molinari" class="staff-picture" />
      <br />
  <span><i class="fa fa-envelope-o"></i>
  <span class="username">roberto.molinari (AT) unige (dot) ch</span></span>
</td>
  ...
  <tr>
    <td><img src="{{ "assets/images/staff/hxu.jpg" | prepend: site.baseurl }}" alt="Haotian Xu" class="staff-picture" />
      <span><i class="fa fa-envelope-o"></i>
  <span class="username">haotian.xu (AT) unige (dot) ch</span></span>
    </td>
    <td><b>Haotian Xu</b></td>
  </tr>
   <tr>
    <td><img src="{{ "assets/images/staff/wyang.jpg" | prepend: site.baseurl }}" alt="Wenchao Yang" class="staff-picture" /><br /> 
      <span><i class="fa fa-envelope-o"></i>
  <span class="username">wyang40 (AT) illinois (dot) EDU</span></span>
    </td>
