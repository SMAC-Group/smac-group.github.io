...
<table>
  <tr>
  <td><img href="{{ "assets/images/staff/sguerrier.jpg" | prepend: site.baseurl }}" alt="Stéphane Guerrier"/></td>
  ...
  <tr>
    <td><img href="{{ "assets/images/staff/jjbalamuta.jpg" | prepend: site.baseurl }}" alt="James Balamuta"/></td>
    <td><b>James Balamuta</b></td>
  </tr>
  <tr>
    <td><img href="{{ "assets/images/staff/rmolinari.jpg" | prepend: site.baseurl }}" alt="Roberto Molinari"/></td>
  ...
  <tr>
    <td><img href="{{ "assets/images/staff/hxu.jpg" | prepend: site.baseurl }}" alt="Haotian Xu"/></td>
