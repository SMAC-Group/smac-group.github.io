...
<table>
  <tr>
  <td><img src="{{ "assets/images/staff/sguerrier.jpg" | prepend: site.baseurl }}" alt="Stéphane Guerrier" class="staff-picture" /></td>
  ...
  <tr>
    <td><img src="{{ "assets/images/staff/jjbalamuta.jpg" | prepend: site.baseurl }}" alt="James Balamuta" class="staff-picture" /></td>
    <td><b>James Balamuta</b></td>
  </tr>
  <tr>
    <td><img src="{{ "assets/images/staff/rmolinari.jpg" | prepend: site.baseurl }}" alt="Roberto Molinari" class="staff-picture" /></td>
  ...
  <tr>
    <td><img src="{{ "assets/images/staff/hxu.jpg" | prepend: site.baseurl }}" alt="Haotian Xu" class="staff-picture" /></td>
    <td><b>Haotian Xu</b></td>
  </tr>
   <tr>
    <td><img src="{{ "assets/images/staff/wyang.jpg" | prepend: site.baseurl }}" alt="Wenchao Yang" class="staff-picture" /></td>
